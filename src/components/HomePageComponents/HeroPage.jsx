...
>
  ...
  <div className="hero-content max-w-3xl z-10">
    <h1 className="text-3xl md:text-5xl font-bold text-white mb-5"  data-aos="fade-right">
      <span ref={typedElement} />
    </h1>
  <div className="max-w-2xl">
<p className="text-[12px] md:text-sm text-white mb-6" data-aos="fade-left">
  Ekiti Municipality Advancement & Modernization Portal (EKAMP) lets you easily apply for birth certificates, local government attestations, and other municipal documents in Ado-Ekiti—all in one place.
</p>
