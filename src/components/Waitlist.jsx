        ...
        <div className="min-h-screen bg-[#03045e] flex flex-col md:flex-row items-center justify-center px-6 py-20 text-white relative overflow-hidden gap-10">
            ...
            <div className="md:w-1/2 max-w-lg mb-10 md:mb-0">
                <h1 className="text-4xl md:text-5xl font-bold mb-6">
                    Bringing Innovation to <span className="text-[#f97316]">Ado Ekiti</span>
                </h1>
                <p className="text-sm text-white/80 mb-6">
                    We’re working behind the scenes to deliver a digital hub that empowers residents, connects services, and fosters innovation.
            ...
            {/* Right Side Form */}
            <div className="md:w-1/2 w-full max-w-md bg-white/5 backdrop-blur-lg rounded-xl p-8 border border-white/10">
                {submitted ? (
                    <div className="text-center">
                        <h2 className="text-2xl font-bold text-gray-200 mb-4">You're on the list!</h2>
                    ...
                    <>
                        <h2 className="text-2xl font-semibold text-white mb-6">Join the Waitlist</h2>
